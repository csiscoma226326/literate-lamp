            ...
            <div className="flex justify-between h-16">
              <div className="flex">
                ...
                <div className="hidden sm:ml-6 sm:flex sm:space-x-8">
                  ...
                  to="/"
                  className={({ isActive }) =>
                  isActive ? 'inline-flex items-center px-1 pt-1 text-sm font-medium bg-gray-900 text-white' : 'inline-flex items-center px-1 pt-1 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white'}>
                  Dashboard
                </NavLink>
                <NavLink
                  to="/Team"
