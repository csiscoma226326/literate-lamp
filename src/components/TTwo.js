const people = [
    ...
    {
      name: 'Bryan Cox',
      role: 'Digital Exp. Design Senior Consultant',
      imageUrl:
        './assets/bcox.jpeg',
      twitterUrl: '#',
      linkedinUrl: '#',
    },
    {
      ...
      role: 'Digital Technology Junior Analyst',
      imageUrl:
        './assets/csiscoma.jpeg',
      twitterUrl: '#',
      linkedinUrl: '#',
    },
    {
      nname: 'Haoxian He',
      role: 'Digital Experience Design Senior Consultant',
      imageUrl:
        './assets/hhe.jpeg',
      twitterUrl: '#',
      linkedinUrl: '#',
    },
    {
      ...
      role: 'Digital Exp. Design Senior Consultant',
      imageUrl:
        './assets/jsalinas.jpeg',
      twitterUrl: '#',
      linkedinUrl: '#',
    },
    {
      name: 'Judy Harris',
      role: 'Digital Experience Design Lead Consultant',
      imageUrl:
        './assets/jharris.png',
      twitterUrl: '#',
      linkedinUrl: '#',
    ...
    {
      name: 'Sanketh Anchan',
      role: 'Digital Experience Design Senior Analayst',
      imageUrl:
        './assets/sanchan.jpeg',
      twitterUrl: '#',
      linkedinUrl: '#',
              ...
              {people.map((person) => (
                <li key={person.name}>
                  <div className="space-y-6">
                    <img className="object-cover w-40 h-40 mx-auto rounded-full xl:w-56 xl:h-56" src={person.imageUrl} alt="" />
